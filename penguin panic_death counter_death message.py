...
Create the penguin:
"""
penguinPic = pygame.image.load('Sliding Penguin.png')
...
"""
Funtion to display a life counter in the top left
"""

def Life_Count(lives):
    font = pygame.font.SysFont(None, 25)
    text = font.render("Lives x{}".format(lives), True, black)
    gameDisplay.blit(text, (0,0))
    
"""
Function for a message following a penguin death
"""
...
def Death():
    ...
    if lives >=2:
        message_display("You died, {} lives remaining".format(lives))
    elif lives == 1:
